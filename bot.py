...
REPORTS_INFO = (
    ...
    "Мы публикуем все подтверждающие документы и чеки[cite: 1]:\n"
    "1. Чеки из ветклиник за стерилизацию и лечение[cite: 1].\n"
    "2. Фото/видео отчеты о состоянии подопечных[cite: 1].\n\n"
